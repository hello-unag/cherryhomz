  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-900">Buy Properties</h1>
          <p className="text-slate-500 font-medium mt-1">Manage properties available for sale.</p>
        </div>
        <button 
          disabled
      ...
      <div className="rounded-2xl border border-slate-200 bg-white shadow-sm min-h-[400px] flex items-center justify-center p-8">
        <div className="text-center max-w-md">
          ...
          <p className="text-slate-500 font-medium mb-6">Click "Add Property" to get started and add your first listing to the marketplace.</p>
        </div>
      </div>
    </div>
  );
