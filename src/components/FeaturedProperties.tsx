    ...
    <section id="properties" className="py-24 px-6 md:px-12 lg:px-20 bg-surface">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center">
          <Link
            href="/buy"
            className="bg-card border-2 border-primary text-primary hover:bg-primary hover:text-white font-semibold py-3 px-8 rounded-xl transition-colors duration-300 inline-flex items-center gap-2 group"
          >
            View All Properties
